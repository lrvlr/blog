...
const BlogPostForm = ({ onSubmit, initialValues }) => {
    ...
    return <View>
        ...
        <Text style={styles.label}>Entert Content:</Text>
        ...
        <Button 
            ...
            //     // send the function to be called after completion
            //    });
            //    Not call inmediatly navigation.navigate('Index') some request may take time
            }   
            }
        />
    </View>
